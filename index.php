...
<div class="page">
    ...
    <!-- Intro -->
    <section class="home_intro  parallax2" data-image="img/wedding/handshold.jpg">
        ...
        <div class="home_txt" data-0="opacity:1" data-top-bottom="opacity:0">
            ...
            <div class="box">
                ...
                <div class="title1"><span>22  -  02</span></div>
    ...
    <section class="married clearfix" id="married">
        <div class="container">
            <div class="im1 parallax" data-bottom="left:30%" data-center="left:0" data-image="img/wedding/ankit_solo_cut.jpg">
                <div class="im_arrows"></div>
            </div>
            <div class="im2 parallax" data-bottom="right:20%" data-center="right:0" data-image="img/wedding/hina_solo_cut.jpg">
                <div class="im_arrows"></div>
            </div>
    ...
    <section class="when_where white_txt parallax" id="when_where" data-image="img/manpho.jpg"
        ...
        <div class="container">
            ...
            <div class="when_where_container opacity">
                ...
                <div class="title1">Dullat Resort</div>
                <div class="title2">Banquet Hall</div>
                <div class="title3"><a class="maplink" href="https://goo.gl/maps/UXGr8UsL1xE2" target="_blank">
                    International, Airport Rd, <br/>  Sector 118, <br/>TDI City, <br/>
                    Mohali,Punjab<br/><i style="color:red"class="flaticon-map35"></i></a></div>

                <div class="pattern2"></div>
                <div class="title1">8 o'clock</div>
                <div class="title5">IN THE EVENING</div>
                <div class="title4">Feb 22nd<br>2019</div>
                ...
                <div class="paper">
                    ...
                    <div id="div_block_1">
                        ...
                        <p>We’re excited to see you! Any questions, just email us at:
                            <a href="mailto:hinanehra@gmail.com">hina</a>
                            <a href="mailto:ankitsood88@gmail.com">ankit</a>
                        </p>
                    </div>
                </div>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/hinankit_ring.JPG" title="Engagement Photos"><b>The Rings</b>
                    </a>
                </div>
                <img src="img/wedding/hinankit_ring.JPG" alt="Gallery 1">
            </div>
        <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/hinaankit_propose.JPG" title="Engagement Photos"><b>Would you?</b>
                    </a>
                </div>
                <img src="img/wedding/hinaankit_propose.JPG" alt="Gallery 1">
            </div>

            <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/hinankit1.JPG" title="Engagement Photos"><b>let's go!!</b>
                    </a>
                </div>
                <img src="img/wedding/hinankit1.JPG" alt="Gallery 2">
            </div>
            <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/hinankit2.JPG" title="Engagement Photos"><b>Can't take my eyes off you!</b>
                    </a>
                </div>
                <img src="img/wedding/hinankit2.JPG" alt="Gallery 2">
            </div>
            <!-- <div class="gallery_item">
                <div class="gallery_txt">
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/papa_mummy.JPG" title="Family Photos"><b>Ankit's Parents</b>
                    </a>
                </div>
                <img src="img/wedding/papa_mummy.JPG" alt="Gallery 1">
            </div>
        <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/papa_mummy2.JPG" title="Family Photos"><b>Hina's Parents</b>
                    </a>
                </div>
                <img src="img/wedding/papa_mummy2.JPG" alt="Gallery 1">
            </div>
        <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/hina_mummy.JPG" title="Family Photos"><b></b>
                    </a>
                </div>
                <img src="img/wedding/hina_mummy.JPG" alt="Gallery 1">
            </div>

            <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/ankit_papa.JPG" title="Family Photo"><b></b>
                    </a>
                </div>
                <img src="img/wedding/ankit_papa.JPG" alt="Gallery 2">
            </div>
            <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/hina_digrp.JPG" title="Family Photo"><b></b>
                    </a>
                </div>
                <img src="img/wedding/hina_digrp.JPG" alt="Gallery 2">
            </div>
            <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/wedding/ankit_di.JPG" title="Family Photo"><b></b>
                    </a>
                </div>
                <img src="img/wedding/ankit_di.JPG" alt="Gallery 2">
            </div>
            <!-- <div class="gallery_item">
                <div class="gallery_txt">
                    <a href="img/gallary2.jpg" title="Engagement Photos"><b>Engagement</b>
    ...
    <section class="footer white_txt parallax" id="footer" data-image="img/wedding/hina_di_grp2.JPG">
        <div class="over"></div>
        <div class="container">
            ...
            <div class="footer_txt">
                ...
                <div class="title1">Ankit &amp; Hina</div>
                <!-- Copyrights -->
                <div class="copyrights"> © 2018 <a href="https://github.com/alankar0416">WebDesigner</a></div>
